...
public class IntArrayBag implements Cloneable
{
   ...
   **/
   ...
   public boolean equalsTo(IntArrayBag iaBag) {
      int max = 0; 
      ...
      for (int i = 0; i < iaBag.manyItems; i++) {
         if (iaBag.data[i] > max) {
            max = iaBag.data[i]; 
         }
      }
      ...
      for (int i = 0; i < this.manyItems; i++) {
         c1[this.data[i]] = c1[this.data[i]] + 1; 
      }

      for (int i = 0; i < iaBag.manyItems; i++) {
         c2[iaBag.data[i]] = c2[iaBag.data[i]] + 1; 
      }
   ...
   public static boolean equalsTo(IntArrayBag iaBag1, IntArrayBag iaBag2) {
      int max = 0; 

      for (int i = 0; i < iaBag1.manyItems; i++) {
         if (iaBag1.data[i] > max) {
            max = iaBag1.data[i];
         }
      }

      for (int i = 0; i < iaBag2.manyItems; i++) {
         if (iaBag2.data[i] > max) {
            max = iaBag2.data[i]; 
         }
      }
      ...
      for (int i = 0; i < iaBag1.manyItems; i++) {
         c1[iaBag1.data[i]] = c1[iaBag1.data[i]] + 1; 
      }

      for (int i = 0; i < iaBag2.manyItems; i++) {
         c2[iaBag2.data[i]] = c2[iaBag2.data[i]] + 1; 
      }
   ...
   public static void main(String[] args) {
      int[] e1 = {1, 2, 1, 3, 1, 4, 1, 5, 1, 6};
      int[] e2 = {2, 4, 6, 5, 3, 1, 1, 1, 1, 1}; 
      ...
      System.out.println("Testing with curretn values"); 
      System.out.println(b1.equalsTo(b2));
      System.out.println(equalsTo(b1, b2)); 

      b1.replace(1, 8);

      System.out.println("Testing with new values (replaced 1 with 8)"); 
      System.out.println(b1.equalsTo(b2));
      System.out.println(equalsTo(b2, b1)); 
   }
}
